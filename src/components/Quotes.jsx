...
function Quotes() {
    ...
    <Carousel.Item>
        ...
        />
        <Carousel.Caption> 
          <p>" Programming is a skill that can be learned and practiced, but it’s also an art form in itself."</p>
          <h5>By Bill Gates </h5>
        </Carousel.Caption>
      </Carousel.Item>
      ...
      <Carousel.Item>
        ...
        />
        <Carousel.Caption>
        <p>“Not everyone needs to be a programmer, but everyone can benefit from learning to code”
        </p>
        <h5>By Elon Musk</h5>
        </Carousel.Caption>
      </Carousel.Item>
      ...
      <Carousel.Item>
        ...
        />
        <Carousel.Caption>
        <p>"Programming isn't about what you know; it's about what you can figure out.”
        </p>
        <h5>By Chris Pine</h5>
        </Carousel.Caption>
      </Carousel.Item>
